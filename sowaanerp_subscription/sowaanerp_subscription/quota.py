...
def user_limit(self, method):
    ...
    count_sowaan_user = quota["count_sowaan_user"]
    allowed_users = quota["users"]
    active_users = validate_users(self, count_administrator_user, count_website_users, count_sowaan_user, allowed_users)
...
def validate_users(self, count_administrator_user, count_website_users, count_sowaan_user, allowed_users):
    '''
